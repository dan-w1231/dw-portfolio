              ...
              <div className="w-full md:w-3/4">
                ...
                >
                  ...
                  <p className="text-xl font-light tracking-tight text-midnight-600 dark:text-ice-600 mt-4 z-[99]">
                    A project with the materials science company Gore, to provide insight into workplace injury in high risk-factor industries, and empower companies to reduce it. 
                  </p>
                </motion.div>
              </div>
            </div>
            {/* <div className="absolute -top-4 -right-0 w-full h-full z-[2]">    
              <Image src={JDEF} alt="" className="absolute -top-16 -right-16 z-[-1] w-1/2 translate-z-0" />
            </div> */}
